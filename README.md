...
- Serves a webapp at `/signalk-updater/` that fetches `GET /plugins/signalk-updater/api/gui-url` and redirects to the Updater Console (default `http://localhost:3003`).
...
| `externalUrl`      | `http://localhost:3003` | Where the Updater Console is reachable.                                                                                                                               |
